...
-(void) joinWriteable:(NSString*)password :(NSString*)room :(NSObject<BridgeObject>*)chatObj :(NSObject<BridgeObject>*)callback;
@end
...
int main (int argc, const char * argv[])
{
  ...
  @autoreleasepool {
    ...
    [remoteAuth joinWriteable:@"bridge-lovers" :@"secret123" :[ChatObj new] :callback];
